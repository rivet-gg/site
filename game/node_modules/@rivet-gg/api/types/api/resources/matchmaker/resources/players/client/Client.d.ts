...
export declare class Players {
    ...
    constructor(options: Players.Options);
    /**
     ...
     */
    connected(request: Rivet.matchmaker.PlayerConnectedRequest): Promise<void>;
    /**
     ...
     * @throws {Rivet.BadRequestError}
     */
    disconnected(request: Rivet.matchmaker.PlayerDisconnectedRequest): Promise<void>;
    /**
     ...
     * @throws {Rivet.BadRequestError}
     */
    getStatistics(): Promise<Rivet.matchmaker.GetStatisticsResponse>;
