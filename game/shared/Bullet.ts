...
export function renderBullet(client: Client, state: BulletState, ctx: CanvasRenderingContext2D) {
  ctx.save();
...
function onPlayerCollision(game: Game, state: BulletState, player: PlayerState) {
