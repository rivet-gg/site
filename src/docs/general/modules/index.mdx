...
Modules come from registries. Rivet provides a default registry with all of the modules available on this website. You can specify or host your own registries easily. Read more [here](/docs/registries).
