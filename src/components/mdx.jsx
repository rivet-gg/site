...
export function RequresBetaSignup() {
  return (
    <Note>
      This guide requires access to the Rivet private beta. Request access
      [here](https://b8v8449klvp.typeform.com/rivet).
    </Note>
  );
}
...
export function EnvPublicToken() {
  return (
    <Info>
      In development, `RIVET_PUBLIC_TOKEN` will use the development token generated by `rivet init`. In
      production, `RIVET_PUBLIC_TOKEN` will be `undefined` and will use [tokenless
      authentication](/general/concepts/tokenless-authentication-web). This can be manually specified if you
      wish. More info: - [Handling game tokens](/general/concepts/handling-game-tokens) - [Development
      tokens](/general/concepts/dev-tokens) - [Public tokens](/general/concepts/token-types#namespace-public)
    </Info>
  );
}
...
export function EnvLobbyToken() {
  return (
    <Info>
      ...
      production, `RIVET_LOBBY_TOKEN` is automatically added to your environment by Rivet. More info: -
      [Handling game tokens](/general/concepts/handling-game-tokens) - [Development
      tokens](/general/concepts/dev-tokens) - [Lobby tokens](/general/concepts/token-types#matchmaker-lobby)
    </Info>
  );
}
...
export function InstallCli() {
  return (
    <Note>
      Make sure you have installed the Rivet CLI [here](https://github.com/rivet-gg/cli#installing).
    </Note>
  );
}
