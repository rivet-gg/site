...
export function EnvTokenClient() {
  return (
    <Info>
      <p>
        In development, `RIVET_TOKEN` will use the development token generated by `rivet init`. In production,
        `RIVET_TOKEN` will be `undefined` and will use{' '}
        <Link href='/docs/general/concepts/tokenless-authentication-web'>tokenless authentication</Link>. This
        can be manually specified if you wish.
      </p>
...
export function EnvTokenServer() {
  return (
    <Info>
      <p>
        In development, `RIVET_TOKEN` will use the development token generated by `rivet init`. In production,
        `RIVET_TOKEN` is automatically added to your environment by Rivet.
      </p>
