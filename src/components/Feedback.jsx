...
export function Feedback() {
    ...
    return (
        <div>
           {/* <RainbowBar className={clsx('h-1 mb-4', 'mx-auto max-w-5xl')} /> */}
...
function EditButton() {
    ...
    return (
        <Button variant='text-subtle' icon={faGithub} href={href} target='_blank'>Edit Page</Button>
    );
}
...
const FeedbackForm = forwardRef(function FeedbackForm({ onSubmit }, ref) {
    return (
        <form
            ref={ref}
            onSubmit={onSubmit}
            className={clsx('absolute inset-0 flex items-center justify-center md:justify-start gap-4', 'mx-auto max-w-5xl')}
        >
            {/* Left */}
...
const FeedbackThanks = forwardRef(function FeedbackThanks(_props, ref) {
    return (
        <div ref={ref} className={clsx('absolute inset-0 flex items-center justify-center md:justify-start gap-4', 'mx-auto max-w-5xl')}>
            {/* Left */}
            <div className='flex items-center bg-orange-50/50 py-1 pl-2 pr-3 text-sm text-orange-900 ring-1 ring-inset ring-orange-500/20 dark:bg-orange-500/5 dark:text-orange-200 dark:ring-orange-500/30 mr-4'>
                <CheckIcon className='h-5 w-5 flex-none mr-3 fill-white' />
