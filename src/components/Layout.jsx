        ...
        <div
          ...
          <div
            className={clsx('min-h-[50vh]', {
              'lg:grid lg:grid-cols-table-of-contents': tableOfContents && !navigation.sidebar,
              'lg:grid lg:grid-cols-two-sidebars': tableOfContents && navigation.sidebar,
              'lg:grid lg:grid-cols-sidebar': !tableOfContents && navigation.sidebar
            })}>
            {/* Sidebar */}
            {navigation.sidebar ? (
              <aside
                className={clsx(
                  `lg:pointer-events-auto lg:sticky lg:top-28 lg:block lg:max-h-content lg:w-72  lg:self-start lg:overflow-y-auto lg:border-r lg:border-charcole-900/10 lg:px-6 lg:pb-8 lg:pt-4 lg:dark:border-white/10 xl:w-80`
                )}>
            ...
            {tableOfContents ? (
              <div
                className={clsx(
                  `lg:pointer-events-auto lg:sticky lg:top-28 lg:block lg:max-h-content lg:w-72 lg:self-start lg:overflow-y-auto lg:px-6 lg:pb-8 lg:pt-4 xl:w-80`
                )}>
                <TableOfContents className='hidden lg:block' tableOfContents={tableOfContents} />
              </div>
            ) : null}
          </div>
        </div>
