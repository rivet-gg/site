...
matchmaker: # How many players can join a specific lobby. # # Read more about matchmaking: https://docs.rivet.gg/matchmaker/concepts/finding-lobby
max_players: 32
...
cdn: # Command to run before uploading the site to Rivet. This can be used to # build any JavaScript bundles or generate assets.
...
<Image className='ml-auto mr-auto block' src={deployment} width={500} alt='Rivet Successful deployment' />
