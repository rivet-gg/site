  ...
  return (
    <div>
      <h1 className='mb-4 flex items-center text-5xl text-white'>
        <ModuleIcon icon={meta.icon} className='mr-4 block max-h-12 text-orange-400' />
        {meta.name}
      </h1>
      <div className='flex gap-0.5 border-b border-cream-100/10 text-white'>
        <ModulePageLink href={`/modules/${params.module}`}>Overview</ModulePageLink>
        ...
        <ModulePageLink href={`/modules/${params.module}/actors`}>
