...
export const config = {
  ...
  date: '2024-04-16',
  title: `Frog Blog`,
  description: `Optimizing Amphibious Agility: Leapfrogging Efficiency in Code`,
  category: 'frogs',
  keywords: ['frogs', 'multiplayer'],
  images: {
    hero: {
      image: frog,
      alt: 'hero'
...
<div style={{ display: 'flex', justifyContent: 'space-around' }}>
  <Image src={frog3} alt="Frog 3" width={300} />
  <Image src={frog4} alt="Frog 4" width={300} />
</div>
...
<div style={{ display: 'flex', justifyContent: 'space-around' }}>
  <Image src={frog5} alt="Frog 5" width={300} />
  <Image src={frog8} alt="Frog 8" width={300} />
</div>
...
<div style={{ display: 'flex', justifyContent: 'space-around' }}>
  <Image src={frog6} alt="Frog 6" width={300} />
  <Image src={frog7} alt="Frog 7" width={300} />
</div>
...
<div style={{ display: 'flex', justifyContent: 'space-around' }}>
  <Image src={frog1} alt="Frog 1" width={400} />
</div>
