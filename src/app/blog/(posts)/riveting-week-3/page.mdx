import image from './riveting-week-3.png';

export const config = {
  author: 'nicholas-kissel',
  date: '2024-05-30',
  title: `Riveting Week 3`,
  description: `Updates and features from our third Riveting Week`,
  category: 'launch-week',
  keywords: ['hub', 'godot', 'pricing', 'cloud'],
  images: {
    hero: {
      image,
      alt: 'hero'
