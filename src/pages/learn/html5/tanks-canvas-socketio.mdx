...
<Accordion title='What did this do?'>
  - Build & upload your Docker image for [Rivet Serverless Lobbies](/docs/serverless-lobbies/index) - Build
  & upload your site for [Rivet CDN](/cdn/index) - Create a version on Rivet - Deploy the version to
