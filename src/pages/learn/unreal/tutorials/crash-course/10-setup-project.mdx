...
### Create project template (or bring your own project)
...
We need to add a target so you can compile your game as a dedicated server to run in Rivet.
...
4. Press the green play button or press _Alt + P_.
5. Validate that you can run around and see your movement synchronized between windows.
