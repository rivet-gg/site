...
# Run the game server
ENTRYPOINT ["/home/nonroot/project/MultiplayerTest2/Binaries/Linux/MultiplayerTest2Server", "MultiplayerTest2", "-server", "-log"]
```
