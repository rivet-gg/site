...
- [MATCHMAKER_PLAYER_ALREADY_CONNECTED](/docs/core/errors/mm/player-already-connected)
- [MATCHMAKER_PLAYER_REGISTRATION_EXPIRED](/docs/core/errors/mm/player-registration-expired)
- [MATCHMAKER_PLAYER_REMOVED](/docs/core/errors/mm/player-removed)
- [MATCHMAKER_PLAYER_IN_DIFFERENT_LOBBY](/docs/core/errors/mm/player-in-different-lobby)
- [TOKEN_INVALID](/docs/core/errors/token/invalid)
