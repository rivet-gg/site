...
<CodeGroup title='Request' tag='POST' label='https://api.rivet.gg/group/groups/{group_id}/avatar-upload/{upload_id}/complete'>

```bash {{ "title": "cURL" }}
curl -X POST 'https://api.rivet.gg/group/groups/{group_id}/avatar-upload/{upload_id}/complete'
```
