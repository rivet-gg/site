...
All lobby servers running on Rivet are automatically provided a unique [lobby token](/docs/general/concepts/token-types#matchmaker-lobby) in the `RIVET_TOKEN` environment variable. No extra work is required.
