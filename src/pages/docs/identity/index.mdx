...
<ResourceGroup>
  ...
  />
  <Resource title='identity.setup' icon={faCode} iconType='duotone' href='/identity/api/post-identities' />
  <Resource title='identity.events.watch' icon={faCode} iconType='duotone' href='/identity/api/get-events-live' />
  <Resource title='identity.links.prepare' icon={faCode} iconType='duotone' href='/identity/api/post-game-links' />
</ResourceGroup>
