...
<CardGroup>
  ...
  />
  <Card title='identity.setup' icon='code' iconType='duotone' href='/identity/api/post-identities' />
  <Card title='identity.events.watch' icon='code' iconType='duotone' href='/identity/api/get-events-live' />
  <Card title='identity.links.prepare' icon='code' iconType='duotone' href='/identity/api/post-game-links' />
</CardGroup>
