...
properties:
  game_activity:
    ...
    description: Information about the identity's current game. This is information
      that all other identities can see about what the current identity is
      doing.
    properties:
      message:
        type: string
...
```json
{
  ...
  "properties": {
    "game_activity": {
      "type": "object",
      "description": "Information about the identity's current game. This is information that all other identities can see about what the current identity is doing.",
      "properties": {
        "message": {
          "type": "string",
          "description": "A short message about the current game activity."
