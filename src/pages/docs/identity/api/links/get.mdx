...
<CodeGroup title='Request' tag='GET' label='https://identity.api.rivet.gg/v1/game-links'>
                      ...
                      game:
                        ...
                        properties:
                          ...
                          name_id:
                            type: string
                            description: A human readable short identifier used to references resources.
                              Different than a `uuid` because this is intended
                              to be human readable. Different than `DisplayName`
                                    ...
                                    game:
                                      ...
                                      properties:
                                        ...
                                        name_id:
                                          type: string
                                          description: A human readable short identifier used to references resources.
                                            Different than a `uuid` because this
                                            is intended to be human readable.
                                            Different than `DisplayName` because
                                            this should not include special
                                            characters and be short.
                                        display_name:
                                          type: string
                                        logo_url:
