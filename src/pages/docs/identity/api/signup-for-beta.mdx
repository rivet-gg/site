...
<DocsJsonSchemaViewer
  schema={{"type":"object","properties":{"name":{"type":"string"},"company_name":{"type":"string"},"company_size":{"type":"string"},"preferred_tools":{"type":"string"},"goals":{"type":"string"}},"required":["name","company_size","preferred_tools","goals"]}}
  expanded={true}
  hideTopBar={false}
