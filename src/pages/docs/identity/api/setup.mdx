...
<CodeGroup title='Request' tag='POST' label='https://identity.api.rivet.gg/v1/identities'>
...
properties:
  ...
  identity_token_expire_ts:
    ...
    format: date-time
    description: >
      If this token is comprimised, anyone with access to this token has control
      of the identity.
  identity:
    type: object
    description: |
...
```json
{
  ...
  "properties": {
    ...
    "identity_token_expire_ts": {
      "type": "string",
      "format": "date-time",
      "description": "If this token is comprimised, anyone with access to this token has control of the identity.\n"
    },
    "identity": {
      "type": "object",
