...
<CodeGroup title='Request' tag='GET' label='https://api.rivet.gg/identity/identities/self/profile'>

```bash {{ title: 'cURL' }}
curl -X GET 'https://api.rivet.gg/identity/identities/self/profile'
```
