...
If you want to implement your own region selection logic, use [matchmaker.regions.list](/matchmaker/api/get-regions) to list all enabled regions for your game.
