...
<CodeGroup title='rivet.yaml'>
  ```yaml matchmaker: game_modes: default: actions: create: enabled: true # Public custom lobbies will be
  listed in the response to `lobbies.list`, private custom # lobbies will not enable_public: true
  enable_private: true max_lobbies_per_identity: 5 # Optional ```
</CodeGroup>
