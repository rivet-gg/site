...
The Rivet Matchmaker is tightly integrated with Serverless Lobbies to automatically boot lobbies on-demand when players need them. Read more about how Rivet Serverless Lobbies operates your game servers [here](/docs/serverless-lobbies/index).
...
<ResourceGroup>
  ...
  <Resource
    ...
    icon={faCode}
    href='/docs/matchmaker/api/post-players-connected'
  />
  <Resource
    title='matchmaker.players.disconnected'
    icon={faCode}
    href='/docs/matchmaker/api/post-players-disconnected'
  />
  <Resource title='matchmaker.lobbies.ready' icon={faCode} href='/docs/matchmaker/api/post-lobbies-ready' />
</ResourceGroup>
