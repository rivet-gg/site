...
import imgSetup from './images/setup.png';
import imgDevelop from './images/develop.png';
import imgDeploy from './images/deploy.png';
...
For this tutorial, [start a new Godot project](https://docs.godotengine.org/en/stable/getting_started/introduction/first_look_at_the_editor.html).

## Step 1: Set up the Rivet Godot plugin

The [Rivet Godot plugin](https://github.com/rivet-gg/plugin-godot) is available to install via `gd-plug` or manually from the github repo.
...
Once you reach Step 4 in the plugin "Setup" tab, start your local game server from the "Develop" tab.
