...
By default, Rivet uses [Rivet Game Guard](/docs//concepts/game-guard) to enable DDoS mitigation and TLS termination out of the box. We recommend using this whenever possible, but on rare occasion you will need to use [host networking](/docs//concepts/host-bridge-networking).
