...
<CodeGroup title='Request' tag='GET' label='https://group.api.rivet.gg/v1/groups/{group_id}/profile'>
  ...
  group:
    ...
    properties:
                  ...
                  properties:
                    ...
                    status:
                      ...
                      description: The current status of an identity. This helps players understand if
                        another player is currently playing or has their game in
                        the background.
                    game_activity:
                      type: object
      ...
      is_current_identity_requesting_join:
        type: boolean
        description: Whether or not the current identity is currently requesting to join
          this group.
      owner_identity_id:
        type: string
        format: uuid
  ...
  "properties": {
    "group": {
      ...
      "properties": {
        ...
        "is_current_identity_requesting_join": {
          "type": "boolean",
          "description": "Whether or not the current identity is currently requesting to join this group."
        },
        "owner_identity_id": {
          "type": "string",
          "format": "uuid"
