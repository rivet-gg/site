...
Disconnect sockets immediately if [matchmaker.players.connected](/docs/matchmaker/api/players/connected) returns an error. Specifically, [MATCHMAKER_PLAYER_NOT_IN_LOBBY](/docs/general/errors/mm/player-not-in-lobby), [MATCHMAKER_PLAYER_ALREADY_CONNECTED](/docs/general/errors/mm/player-already-connected), and [TOKEN_INVALID](/docs/general/errors/token/invalid) indicate the player may be malicious.
