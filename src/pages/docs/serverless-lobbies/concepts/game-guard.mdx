...
Disconnect sockets immediately if [matchmaker.players.connected](/docs/matchmaker/api/players/connected) returns an error. Specifically:

- [MATCHMAKER_PLAYER_ALREADY_CONNECTED](/docs/general/errors/mm/player-already-connected)
- [MATCHMAKER_PLAYER_NOT_IN_LOBBY](/docs/general/errors/mm/player-not-in-lobby)
...
- [MATCHMAKER_jPLAYER_IN_DIFFERENT_LOBBY](/docs/general/errors/mm/player-in-different-lobby)
