...
import { faGraduationCap, faBooks, faChessKnight, faServer, faGlobe, faKey } from '@fortawesome/pro-solid-svg-icons';
...
<ResourceGroup>
  ...
  <Resource title='Serverless Lobbies' icon={faServer} iconType='duotone' href='/serverless-lobbies/introduction'>
