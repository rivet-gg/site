  ...
  custom_avatars:
    ...
    items:
      ...
      properties:
        ...
        url:
          type: string
          description: The URL of this custom avatar image. Only present if upload is
            complete.
        content_length:
          type: integer
          format: int64
    ...
    "custom_avatars": {
      ...
      "items": {
        ...
        "properties": {
          ...
          "url": {
            "type": "string",
            "description": "The URL of this custom avatar image. Only present if upload is complete."
          },
          "content_length": {
            "type": "integer",
            "format": "int64",
