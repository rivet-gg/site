          ...
          cdn:
            ...
            properties:
              enable_domain_public_auth:
                type: boolean
                description: Whether or not to allow users to connect to the given namespace via
                  domain name.
              domains:
                type: array
                items:
          ...
          "properties": {
            "cdn": {
              ...
              "properties": {
                "enable_domain_public_auth": {
                  "type": "boolean",
                  "description": "Whether or not to allow users to connect to the given namespace via domain name."
                },
                "domains": {
                  "type": "array",
                  "items": {
