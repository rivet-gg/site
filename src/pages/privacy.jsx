export default function Privacy() {
  return (
    <article>
      ...
      <p>Last updated: December 6th, 2021</p>
      <p>
      ...
      <ul role='list'>
        ...
        <li>
          <strong>Business</strong>, for the purpose of the CCPA (California Consumer Privacy Act), refers to
        ...
        <li>
          <strong>Website</strong> refers to Rivet, accessible from{' '}
          <a href='https://rivet.gg/'>
            <strong>https://rivet.gg/</strong>
          </a>
        </li>
        <li>
      ...
      <ul role='list'>
        ...
        <li>
          ...
          Cookies. For more information on how You can delete Flash Cookies, please read "Where can I change
          the settings for disabling, or deleting local shared objects?" available at{' '}
      ...
      <p>
        ...
        <a href='https://www.termsfeed.com/blog/cookies/'>
          <strong>All About Cookies by TermsFeed</strong>
        </a>
        .
      </p>
      ...
      <ul role='list'>
        ...
        <li>
          Purpose: These Cookies are used to track information about traffic to the Website and how users use
      ...
      <ul role='list'>
        ...
        <li>
          ...
          <a href='https://www.twilio.com/legal/privacy/'>
            <strong>https://www.twilio.com/legal/privacy/</strong>
          </a>
        </li>
      </ul>
      <h2>Payments</h2>
      ...
      <ul role='list'>
        ...
        <li>
          ...
          <a href='https://www.apple.com/legal/privacy/en-ww/'>
            <strong>https://www.apple.com/legal/privacy/en-ww/</strong>
          </a>
        </li>
        <li>
        ...
        <li>
          ...
          <a href='https://www.google.com/policies/privacy/'>
            <strong>https://www.google.com/policies/privacy/</strong>
          </a>
        </li>
        <li>
        ...
        <li>
          ...
          <a href='https://stripe.com/us/privacy/'>
            <strong>https://stripe.com/us/privacy/</strong>
          </a>
        </li>
        <li>
        ...
        <li>
          ...
          <a href='https://www.paypal.com/webapps/mpp/ua/privacy-full/'>
            <strong>https://www.paypal.com/webapps/mpp/ua/privacy-full/</strong>
          </a>
        </li>
      </ul>
      <p>
      ...
      <p>
        ...
        This does not mean that all examples of that category of personal information were in fact collected
        by Us, but reflects our good faith belief to the best of our knowledge that some of that information
        from the applicable category may be and may have been collected. For example, certain categories of
        personal information would only be collected if You provided such personal information directly to Us.
      </p>
      <ul role='list'>
        <li>
        ...
        <li>Examples: Records and history of products or services purchased or considered.</li>
        <li>Collected: Yes.</li>
        <li>
        ...
        <li>Examples: Interaction with our Service or advertisement.</li>
        <li>Collected: Yes.</li>
        <li>
      ...
      <p>
        ...
        more details on how we use this information, please refer to the "Use of Your Personal Data" section.
      </p>
      <p>
        If We decide to collect additional categories of personal information or use the personal information
        We collected for materially different, unrelated, or incompatible purposes We will update this Privacy
        Policy.
      </p>
      ...
      <p>
        ...
        consideration. This means that We may have received some kind of benefit in return for sharing
      ...
      <ul role='list'>
        ...
        <li>
          ...
          <a href='http://www.youronlinechoices.com/'>
            <strong>http://www.youronlinechoices.com/</strong>
          </a>
        </li>
        <li>
          The DAA's opt-out platform:{' '}
          <a href='http://optout.aboutads.info/?c=2&amp;lang=EN'>
            <strong>http://optout.aboutads.info/?c=2&amp;lang=EN</strong>
          </a>
        </li>
      </ul>
      <p>
      ...
      <h1>Contact Us</h1>
      <p>
        If you have any questions about this Privacy Policy, You can contact us by visiting this page on our
        website:{' '}
        <a href='https://rivet.gg/support/'>
          <strong>https://rivet.gg/support/</strong>
        </a>
