    ...
    <article>
      ...
      <ul role='list'>
        <li>
          ...
          any electronic device, named Rivet
        </li>
        <li>
        ...
        <li>
          ...
          Agreement) refers to Rivet Gaming LLC, 1401 Lavaca Street Unit #274 Austin, TX 78701.
        </li>
        <li>
        ...
        <li>
          <strong>Developer Group</strong> refers to a group of Accounts that have access to a Developer Group
          Console.
        </li>
        <li>
          <strong>Developer Group Console</strong> refers to the online tool provided by Rivet Gaming for
        ...
        <li>
          <strong>End Users</strong> means users of the Customer's Service account that are apart of the
          Developer Group and have access to the Developer Group Console. This may include Customer's
          employees, students, or their affiliates.
        </li>
        <li>
      ...
      <p>
        You represent that you are at least over the age of 13 or the minimum age to use a Service without
        parental approval in your home country. The Company does not permit those under 13 or under the age of
        parental approval in your home country to use the Service. The minimum age to use our Services without
      ...
      <p>
        We will reimburse You no later than 14 days from the day on which We receive the returned Goods. We
        will use the same means of payment as You used for the Order, and You will not incur any fees for such
        reimbursement.
      </p>
      ...
      <p>
        ...
        downloaded, we will, after becoming aware of the fault or being notified to the fault by You,
        investigate the reason for the fault. We will act reasonably in deciding whether to provide You with a
        replacement In-app Purchase or issue You with a patch to repair the fault. In no event will We charge
        You to replace or repair the In-app Purchase. In the unlikely event that we are unable to replace or
        repair the relevant In-app Purchase or are unable to do so within a reasonable period of time and
        without significant inconvenience to You, We will authorize the Application Store to refund You an
        amount up to the cost of the relevant In-app Purchase. Alternatively, if You wish to request a refund,
        You may do so by contacting the Application Store directly.
      </p>
      <p>
      ...
      <h1>Developer Charges &amp; Fees</h1>
      <p>
        If you elect to add funds to your account and use such funds to pay the Fees due, you are responsible
        for ensuring that such funds cover the Fees due. If your account does not have sufficient funds or
        your credit card declines a charge for the Fees due, we reserve the right to suspend the Services to
        all of your accounts until the Fees due are paid in full.
      </p>
      <p>
        Invoices will be sent to you each month via email to the email address you designate in your account.
        You will pay the Fees due within thirty (30) days of the date of the invoice. Except as otherwise set
        forth in the applicable Order Form(s), Fees are payable in United States dollars. If you fail to pay
        the Fees and remedy such failure within fifteen (15) days of the date we provide you with written
        notice of the same, we may (a) assess, and you will pay, a late fee of the lesser of 1.5% per month or
        the maximum amount allowable by applicable law and (b) suspend the Services to all of your accounts
        until the Fees are paid in full.
      </p>
      <p>
        You will notify us in writing within thirty (30) days of the date we bill you for any Fees that you
        wish to dispute. You may withhold the disputed Fees until the dispute is resolved. Where you are
        disputing any Fees, you must act reasonably and in good faith and will cooperate diligently with us to
        resolve the dispute. We will not charge you a late fee or suspend the provision of the Services for
        unpaid Fees that are in dispute, unless you fail to cooperate diligently with us or we determine your
        dispute is not reasonable or brought in good faith.
      </p>
      <p>
        Fees and charges that are billed for usage, such as the service Matchmaker, are billed by the second.
        Usage is rounded up to the nearest second and cent.
      </p>
      <h1>Promotions</h1>
      <p>
      ...
      <p>
        The Company may offer service credits which are all revocable at any given time, without warning, for
        any given reason, including violating these Terms and Conditions, abuse, illegal conduct, and
        misrepresenting account information. You are not subject to receiving any form of compensation of any
        kind for the loss of Service Credits.
      </p>
      <h1>User Accounts</h1>
      <p>
      ...
      <p>
        By posting, uploading, submitting, or storing Content to the Service, You grant Us and Digital Ocean
        (and those we work with) a worldwide right and license to use, modify, publicly perform, publicly
        display, reproduce, and distribute such Content on and through the Service. You retain any and all of
        Your rights to any Content You submit,uploading, submitting, or storing post or display on or through
        the Service and You are responsible for protecting those rights. You agree that this license includes
        the right for Us to make Your Content available to other users of the Service, who may also use Your
      ...
      <p>
        The Company reserves the right, but not the obligation, to, in its sole discretion, determine whether
        or not any Content is appropriate and complies with this Terms, refuse or remove this Content. The
        Company further reserves the right to make formatting and edits and change the manner any Content. The
        Company can also limit or revoke the use of the Service if You post such objectionable Content. As the
        Company cannot control all content posted by users and/or third parties on the Service, you agree to
        use the Service at your own risk. You understand that by using the Service You may be exposed to
      ...
      <p>
        Although regular backups of Content are performed, the Company do not guarantee there will be no loss
      ...
      <h2>Content Administration Service</h2>
      <p>
        You may specify End Users through the Developer Group Console. Group Members may be able to: (a)
        access, disclose, restrict or remove Customer Data in or from End User Accounts; and (b) monitor,
        restrict, or terminate access to End User Accounts. You are responsible for maintaining the
        confidentiality of passwords and group Accounts. The Company's responsibilities do not extend to the
        internal management or administration of the Services for Customer.
      </p>
      <h2>Securing your Content</h2>
      <p>
        You are responsible to provide proper security and maintenance of your content that is using the
        Company's Services; including but not limited to spamming, phishing,{' '}
        <a href='https://rivet.gg/acceptable-use'>
          <strong>The Acceptable Use Policy</strong>
        </a>
        , "DoS"; which may increase the cost for using the Company's Services, which your are responsible to
        pay.
      </p>
      ...
      <p>
        ...
        work has been copied in a way that constitutes copyright infringement that is taking place through the
        Service, You must submit Your notice in writing to the attention of our copyright agent via email at{' '}
        <a href='mailto:dmca@rivet.gg'>
          <strong>dmca@rivet.gg</strong>
        </a>{' '}
      ...
      <p>
        ...
        <a href='mailto:legal@rivet.gg'>
          <strong>legal@rivet.gg</strong>
        </a>{' '}
        Upon receipt of a notification, the Company will take whatever action, in its sole discretion, it
      ...
      <h1>Contact Us</h1>
      <p>
        If you have any questions about these Terms and Conditions, You can contact us by visiting this page
        on our website:{' '}
        <a href='https://rivet.gg/support/'>
          <strong>https://rivet.gg/support/</strong>
        </a>
      </p>
    </article>
  );
